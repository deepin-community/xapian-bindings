...
public class Compactor : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Compactor obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private void SwigDirectorConnect() {
    if (SwigDerivedClassHasMethod("SetStatus", swigMethodTypes0))
      swigDelegate0 = new SwigDelegateCompactor_0(SwigDirectorMethodSetStatus);
    if (SwigDerivedClassHasMethod("ResolveDuplicateMetadata", swigMethodTypes1))
      swigDelegate1 = new SwigDelegateCompactor_1(SwigDirectorMethodResolveDuplicateMetadata);
  ...
  private bool SwigDerivedClassHasMethod(string methodName, global::System.Type[] methodTypes) {
    ...
    foreach (global::System.Reflection.MethodInfo methodInfo in methodInfos) {
      ...
      if (methodInfo.IsVirtual && (methodInfo.DeclaringType.IsSubclassOf(typeof(Compactor))) &&
  ...
  private void SwigDirectorMethodSetStatus(string table, string status) {
    SetStatus(table, status);
  }

  private string SwigDirectorMethodResolveDuplicateMetadata(string key, uint num_tags, global::System.IntPtr tags) {
