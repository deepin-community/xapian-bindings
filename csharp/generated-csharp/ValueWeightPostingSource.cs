...
public class ValueWeightPostingSource : ValuePostingSource {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ValueWeightPostingSource obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private void SwigDirectorConnect() {
    if (SwigDerivedClassHasMethod("GetTermfreqMin", swigMethodTypes0))
      swigDelegate0 = new SwigDelegateValueWeightPostingSource_0(SwigDirectorMethodGetTermfreqMin);
    if (SwigDerivedClassHasMethod("GetTermfreqEst", swigMethodTypes1))
      swigDelegate1 = new SwigDelegateValueWeightPostingSource_1(SwigDirectorMethodGetTermfreqEst);
    if (SwigDerivedClassHasMethod("GetTermfreqMax", swigMethodTypes2))
      swigDelegate2 = new SwigDelegateValueWeightPostingSource_2(SwigDirectorMethodGetTermfreqMax);
    if (SwigDerivedClassHasMethod("GetWeight", swigMethodTypes3))
      swigDelegate3 = new SwigDelegateValueWeightPostingSource_3(SwigDirectorMethodGetWeight);
    if (SwigDerivedClassHasMethod("GetDocId", swigMethodTypes4))
      swigDelegate4 = new SwigDelegateValueWeightPostingSource_4(SwigDirectorMethodGetDocId);
    if (SwigDerivedClassHasMethod("Next", swigMethodTypes5))
      swigDelegate5 = new SwigDelegateValueWeightPostingSource_5(SwigDirectorMethodNext);
    if (SwigDerivedClassHasMethod("SkipTo", swigMethodTypes6))
      swigDelegate6 = new SwigDelegateValueWeightPostingSource_6(SwigDirectorMethodSkipTo);
    if (SwigDerivedClassHasMethod("Check", swigMethodTypes7))
      swigDelegate7 = new SwigDelegateValueWeightPostingSource_7(SwigDirectorMethodCheck);
    if (SwigDerivedClassHasMethod("AtEnd", swigMethodTypes8))
      swigDelegate8 = new SwigDelegateValueWeightPostingSource_8(SwigDirectorMethodAtEnd);
    if (SwigDerivedClassHasMethod("Name", swigMethodTypes9))
      swigDelegate9 = new SwigDelegateValueWeightPostingSource_9(SwigDirectorMethodName);
    if (SwigDerivedClassHasMethod("Init", swigMethodTypes10))
      swigDelegate10 = new SwigDelegateValueWeightPostingSource_10(SwigDirectorMethodInit);
    if (SwigDerivedClassHasMethod("GetDescription", swigMethodTypes11))
      swigDelegate11 = new SwigDelegateValueWeightPostingSource_11(SwigDirectorMethodGetDescription);
  ...
  private bool SwigDerivedClassHasMethod(string methodName, global::System.Type[] methodTypes) {
    ...
    foreach (global::System.Reflection.MethodInfo methodInfo in methodInfos) {
      ...
      if (methodInfo.IsVirtual && (methodInfo.DeclaringType.IsSubclassOf(typeof(ValueWeightPostingSource))) &&
