...
public:
    ...
    typedef const char * (SWIGSTDCALL* SWIG_Callback0_t)(const char *);
...
public:
    ...
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback0_t)(const char *);
    void swig_connect_director(SWIG_Callback0_t callbackApply);
...
public:
    ...
    typedef const char * (SWIGSTDCALL* SWIG_Callback0_t)(void *);
    void swig_connect_director(SWIG_Callback0_t callbackApply);
...
public:
    ...
    typedef const char * (SWIGSTDCALL* SWIG_Callback9_t)();
    typedef void (SWIGSTDCALL* SWIG_Callback10_t)(void *);
    typedef const char * (SWIGSTDCALL* SWIG_Callback11_t)();
